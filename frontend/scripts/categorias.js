...
const categorias = [
    ...
    { id: "cafe-chocolate",tipo:["flexibles", "termoformados"], nombre: "Caf� y Chocolate", imagen: "assets/images/categorias/cafe-chocolate.png",

     },
    { id: "carnicos", tipo:["flexibles","carnicos"], nombre: "C�rnicos", imagen: "assets/images/categorias/carnicos.png",
         },

    { id: "mascotas", tipo:["flexibles"], nombre: "Mascotas", imagen: "assets/images/categorias/mascotas.png" },

    { id: "panaderia", tipo:["flexibles", "termoformados"], nombre:"Panader�a y Reposter�a", imagen: "assets/images/categorias/panaderia.png" },
